...
import pytest
from ast.bq_builders import b, ValidationError, Identifier, Literal, BinaryOp
...
class TestBinaryOperations:
    ...
    def test_invalid_operands(self):
        with pytest.raises(TypeError, match="Both operands must be Expression instances"):
...
class TestFunctions:
    ...
    def test_invalid_function_args(self):
        with pytest.raises(TypeError, match="All function arguments must be Expression instances"):
...
class TestComplexBuilders:
    ...
    def test_window_function(self):
        ...
        row_num.order_by = [
            b.Builders.OrderByClause(b.col('order_date'), 'DESC')
        ]
